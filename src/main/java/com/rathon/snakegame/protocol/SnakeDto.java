 ...
 */
public record SnakeDto(String id, String nickname, boolean boosting, List<double[]> segments) {
    ...
    public static SnakeDto from(Snake snake) {
        List<double[]> segments = snake.segmentsView().stream()
                ...
                .toList();
        return new SnakeDto(snake.getId(), snake.getNickname(), snake.isBoosting(), segments);
    }
